    ...
    public class AiChatBotController : ControllerBase
    {
        ...
        private readonly List<BotIntent> intents = new()
        {
            ...
            new BotIntent
            {
                ...
                Response =
                "👋 Hello! Welcome to SmartGriev Assistant.\n\n" +
                "I can help you with:\n" +
                "• Register complaints\n" +
            ...
            new BotIntent
            {
                ...
                Keywords = new[]
                {
                    "smartgriev", "what is smartgriev",
                    "about system", "explain system",
                    "what does it do", "how this app works"
                },
                Response =
                "🏢 SmartGriev is a digital grievance management system for Surat City.\n\n" +
                "Citizens can:\n" +
                "• Report civic issues\n" +
            ...
            new BotIntent
            {
                ...
                Keywords = new[]
                {
                    ...
                    "workflow", "system work"
                },
                Response =
                "⚙ SmartGriev Complaint Process:\n\n" +
            ...
            new BotIntent
            {
                ...
                Keywords = new[]
                {
                    "register complaint", "file complaint",
                    "submit complaint", "raise complaint",
                    "new complaint", "grievance",
                    "i want to complain"
                },
                Response =
            ...
            new BotIntent
            {
                ...
                Keywords = new[]
                {
                    ...
                    "street damage", "bad road"
                },
                Response =
                "🛣 Road-related complaint detected.\n\n" +
                "Please submit:\n" +
                "• Exact location\n" +
                "• Road issue details\n" +
            ...
            new BotIntent
            {
                ...
                Keywords = new[]
                {
                    ...
                    "electric wire", "light problem",
                    "power issue", "electric pole"
                },
                Response =
            ...
            new BotIntent
            {
                ...
                {
                    "drainage", "drain",
                    "water overflow", "blocked drain",
                    "sewage"
                },
                Response =
                "🚧 Drainage complaint detected.\n\n" +
                "Please provide:\n" +
            ...
            new BotIntent
            {
                ...
                Keywords = new[]
                {
                    "history", "old complaints",
                    "past complaints", "previous complaints"
                },
                Response =
                "📂 Your complaint history is available in the 'My Complaints' section."
            },
            ...
            new BotIntent
            {
                ...
                Keywords = new[]
                {
                    "dashboard", "total complaints",
                    "count", "how many complaints"
                },
                Response =
                "📊 Dashboard shows:\n\n" +
                "• Total complaints\n" +
        ...
        private string GetSmartResponse(string msg)
        {
            msg = msg.ToLower().Trim();

            var bestMatch = intents
                .Select(intent => new
                {
                    Intent = intent,

                    Score = intent.Keywords.Count(keyword =>

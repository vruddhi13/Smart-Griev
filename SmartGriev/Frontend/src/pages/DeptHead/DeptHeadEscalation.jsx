...
import {
    getComplaintHistory,
    getDeptHeadComplaintDetails,
    getEscalatedComplaints   // ✅ ADD THIS
...
const DeptHeadEscalation = () => {
    ...
    const openDetails = async (
        ...
        try {
            ...
            const data = await getDeptHeadComplaintDetails(complaintId);
    ...
    return (
        ...
        <DeptLayout pageTitle="Escalated Complaints">
                                ...
                                <>
                                    ...
                                    >
                                        <InfoCard title="Complaint Number" value={complaintDetails?.complaintNumber} />
                                            ...
                                            <InfoCard title="Citizen" value={complaintDetails?.userName} />
                                        ...
                                        <InfoCard title="Status" value={complaintDetails?.status} />
                                            ...
                                            <InfoCard title="Assigned Officer" value={complaintDetails?.assignedToName} />

                                            <InfoCard title="Escalated Officer" value={complaintDetails?.escalatedToName} />
...
export default DeptHeadEscalation;
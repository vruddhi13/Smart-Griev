...
import { getDepartments, addDepartment, updateDepartment, deleteDepartment } from "../../services/AdminServices/AdminService"; 
                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                        <thead>
                            <tr style={{ borderBottom: '1px solid #F4F7FE', background: '#FAFCFF' }}>
                                ...
                                <th style={{ padding: '20px', color: '#A3AED0', fontSize: '12px', fontWeight: 'bold' }}>NAME</th>
